...
public class NavDrawer_ListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtTitle = (TextView) convertView.findViewById(R.id.drawelistitem_title);
        TextView txtCount = (TextView) convertView.findViewById(R.id.drawelistitem_counter);
